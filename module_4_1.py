...
from fake_math import divide as div_classic
from true_math import divide as div_extended

A = [1, 2, 3, 0]
B = [0, 4, 2, 1]

print('a / b\tClassic\tExtended\n' + '_' * 24)
for a, b in zip(A, B):
    print(f'{a} / {b}\t{div_classic(a, b)}\t{div_extended(a, b)}')